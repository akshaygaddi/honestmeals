          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                Your partner in achieving fitness goals with healthy, delicious meals delivered to your doorstep.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/meals" className="text-gray-300 hover:text-white transition">Meals</a></li>
                <li><a href="/subscription" className="text-gray-300 hover:text-white transition">Subscriptions</a></li>
